...
The Tabler Icons SVG icons are created by [Tabler](https://github.com/tabler/tabler-icons) and licensed under [MIT](https://github.com/tabler/tabler-icons/blob/master/LICENSE).
